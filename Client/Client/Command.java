...
public enum Command {
        /* Crashes */
        ResetCrashes("Reset all enabled crashes", ""),
        CrashMiddleware("Enable a crash mode at the middleware", "<Mode>"),
        CrashResourceManager("Enable a crash mode at the resource managers", "<Mode>"),
